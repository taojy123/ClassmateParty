...
import sys
import webbrowser
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "classmate_party.settings")
#these pertain to your application
import classmate_party.wsgi
import classmate_party.urls
import classmate_party.settings
import classmate_party.models
import classmate_party.views
